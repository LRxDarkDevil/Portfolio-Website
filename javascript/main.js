...
function createScrollToTop() {
    ...
    scrollBtn.addEventListener('mouseenter', () => {
        ...
        scrollBtn.style.boxShadow = '0 6px 20px rgba(0, 212, 255, 0.4)';
    });
    
    scrollBtn.addEventListener('mouseleave', () => {
        scrollBtn.style.transform = 'translateY(0)';
        scrollBtn.style.boxShadow = '0 4px 12px rgba(0, 212, 255, 0.3)';
    });
}
...
// Also update year on page load to ensure it's current
